...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <div className="flex flex-col items-center bg-[#F2F2F2] w-full p-12">
        ...
        <button className="flex items-center justify-center bg-[#4D4D4D] rounded-2xl px-8 py-3">
          <p className="text-white text-xl">Start Now</p>
        </button>
        <p className="text-[#999999] mt-4">Get your first plan free!</p>
      </div>
      {/* Section 2: Features */}
      <div className="flex flex-col bg-[#D9D9D9] w-full p-12 gap-24">
      ...
      {/* Section 3: Use Cases */}
      <div className="flex flex-col items-center bg-[#F2F2F2] w-full">
      ...
      <div className="flex flex-col items-center bg-[#808080] w-full p-12 gap-8">
